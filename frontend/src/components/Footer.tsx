        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="bg-white p-3 rounded-2xl mb-4 w-fit inline-flex shadow-sm">
              <img src="/image.png" alt="SangVital Logo" width={130} height={130} className="object-contain" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/60">
              ...
              <li><Link to="/centres-don" className="hover:text-background transition-colors">{f.donationCenters}</Link></li>
