...
<head>
    ...
    <title>Bienvenue - Votre Espace Donneur</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p style="margin: 8px 0 0 0; opacity: 0.9; font-size: 14px;">Votre compte donneur a été créé avec succès</p>
        </div>
        ...
        <div class="content">
            ...
            <p class="message-text">
                Nous sommes ravis de vous compter parmi nos donneurs héroïques ! Votre compte de donneur de sang a été créé sur la plateforme <strong>DonSang</strong>. Voici vos identifiants pour vous connecter et suivre votre historique de dons :
            </p>
            ...
            <div class="warning-box">
                ⚠️ <strong>Important :</strong> Pour votre sécurité, nous vous recommandons de changer votre mot de passe dès votre première connexion dans l'onglet Profil.
            </div>
 
            <!-- CTA Button -->
            <div class="cta-container">
                <a href="{{ $appUrl }}/login" class="cta-button">
                    Accéder à mon espace Donneur
                </a>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <p>Merci pour votre générosité. Chaque don sauve des vies ! 🩸</p>
